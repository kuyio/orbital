...
class dark_mode_controller_default extends Controller {
  connect() {
  ...
  toggle() {
    ...
    this.updateIcon();
    const themeCtrl = this.application.getControllerForElementAndIdentifier(document.querySelector('[data-controller~="theme"]'), "theme");
    if (themeCtrl)
      themeCtrl.apply(themeCtrl.currentValue);
  }
  updateIcon() {
...
class theme_controller_default extends Controller {
  ...
  apply(name) {
    ...
    Object.keys(THEMES.blue).forEach((prop) => {
...
//# debugId=19E54E119DDBF9C264756E2164756E21
